...
絶対パス、フォルダ列挙結果、汎用ファイルアクセス関数はWebViewへ渡しません。

アプリ資産と開いている文書フォルダは別の仮想ホストへ割り当て、文書フォルダ側はCSPの `img-src` だけで使います。
...
Windowsアプリ版の相対画像は、開いている文書フォルダだけを割り当てた画像専用仮想ホストから表示します。
