...
assert.match(assemblyInfo, /AssemblyVersion\("1\.0\.3\.0"\)/);
assert.match(assemblyInfo, /AssemblyFileVersion\("1\.0\.3\.0"\)/);
assert.match(assemblyInfo, /AssemblyInformationalVersion\("1\.0\.3"\)/);
