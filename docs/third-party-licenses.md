...
| ProseMirror local bundle | see package table below | Rich editor transaction model | MIT | `vendor/prosemirror/editor-integration.js`, `vendor/prosemirror/prosemirror-editor.js`, `vendor/prosemirror/licenses/`, `vendor/prosemirror/package-lock.json` |
